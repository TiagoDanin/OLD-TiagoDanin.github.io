...
(function (global, factory) {
    (typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? module.exports = factory() : typeof define === 'function' && define.amd ? define('uikit', factory) : global.UIkit = factory();
})(undefined, function () {
    'use strict';
    ...
    var hasTouch = hasTouchEvents || win.DocumentTouch && doc instanceof DocumentTouch || navigator.maxTouchPoints; // IE >=11
        ...
        UIkit.component('navbar', {
            ...
            methods: {
                ...
                transitionTo: function transitionTo(newHeight, el) {
                    ...
                    return Transition.start([el, dropbar], { height: newHeight }, this.duration).catch(noop).finally(function () {
